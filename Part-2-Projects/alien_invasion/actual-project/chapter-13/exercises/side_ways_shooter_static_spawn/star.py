...
class Star(Sprite):
    def __init__(self, shooter_game):
        ...
        self.image = pygame.image.load("/home/ppv/Documents/ppv-skill-dev/python/codes/github/Python-CrashCourse/Part-2-Projects/alien_invasion/actual-project/chapter-13/exercises/images/star.bmp")
